...
public class Main {
  public static void main(String args[]) {
    ...
    try {
      String line = FileUtils.readFileToString(new File("C://Users//nikky//Desktop//WikiRef_dataset//WikiRef_dataset//WikiRef150//barack.obama.1.txt"));
      nextLine = line;
...
// a CoreMap is essentially a Map that uses class objects as keys and has values with custom types
    ...
    try {
      ...
      System.out.println("Welcome to AskMeAnything!!!");
      ...
      for (CoreLabel token1 : sentence.get(CoreAnnotations.TokensAnnotation.class)) {
        ...
        if (par1.contentEquals("WP")) {
          ...
          if (par4.contentEquals("NN")) {
            ...
            System.out.println("Question not detected!!Please ask another question");
